    ...
    <form action="#" @submit.prevent="submitForm">
      <div class="p-3">
        <div class="mb-4 text-center">
          <span>
            <i class="refund-icon fas fa-exclamation-circle"></i>
          </span>
        </div>

        <div class="mb-3 text-center">
          <div class="label-1 font-weight-bold">Are You Sure?</div>
        </div>

        <div class="mb-4 text-center">
          <div class="label-2">This action cannot be undone.</div>
        </div>
...
@Component
export default class RefundModalComponent extends BaseVue {
  public $refs!: {
    modal: any;
  };
  ...
  private submitForm() {
    this.api.refundOrder(this.$route.params.eventId, this.orderId)
