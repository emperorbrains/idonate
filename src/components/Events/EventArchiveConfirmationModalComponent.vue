  ...
  <b-modal :id="id" ref="modal" centered hide-footer hide-header>
    <div>
      <div class="p-3">
        ...
        <h3 class="mb-4 font-weight-semibold text-center">Do you want archive<br>the event?</h3>
...
@Component
export default class EventArchiveConfirmationModalComponent extends BaseVue {
  public $refs!: {
    modal: any;
  };
  ...
  private archiveEvent() {
    // Do some processing ...
    this.api.archiveEvent(this.$route.params.eventId)
    .then((res) => this.handleSuccess(res, '', 'data.event.archive.errors'))
    .catch(this.handleFailure);

    this.$emit('archive-event');
