  ...
  <b-modal :id="id" ref="modal" centered hide-footer hide-header>
    <div>
      <div class="p-3">
        ...
        <h3 class="mb-4 font-weight-semibold text-center">Do you want to create a<br>new Peer-to-Peer program?</h3>
...
export default class CreateP2PModalComponent extends Vue {
  public $refs!: {
    modal: any;
  };
